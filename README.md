...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yapic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15276&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yapic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yapic` can be installed with:

```
conda install yapic
```

It is possible to list all of the versions of `yapic` available on your platform with:
